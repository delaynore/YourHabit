...
namespace YourHabit.Api.Migrations.Application
{
    ...
    [Migration("20250327114222_Rename_Description_Column")]
    partial class Rename_Description_Column
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YourHabit.Api.Entities.Tag", b =>
                {
                    ...
                    b.ToTable("tags", "your_habit");
                });

            modelBuilder.Entity("YourHabit.Api.Entities.Habit", b =>
                {
                    b.OwnsOne("YourHabit.Api.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("YourHabit.Api.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("YourHabit.Api.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
